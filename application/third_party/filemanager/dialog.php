...
?>
	...
	<head>
		...
		<link href="<?php echo base_url('assets/admin/css/bootstrap-lightbox.min.css'); ?>" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url('assets/admin/css/fmstyle.css'); ?>" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url('assets/admin/css/dropzone.min.css'); ?>" rel="stylesheet" type="text/css" />
		<?php
		$sprite_lang_file = "<?php echo base_url('assets/admin/img/spritemap_en_EN.png');?>";
		$sprite_lang_file = "<?php echo base_url('assets/admin/img/spritemap@2x_en_EN.png');?>";
		...
		<link href="<?php echo base_url('assets/admin/fm/css/jquery.contextMenu.min.css'); ?>" rel="stylesheet" type="text/css" />
		<link href="<?php echo base_url('assets/admin/fm/css/bootstrap-modal.min.css'); ?>" rel="stylesheet" type="text/css" />
		<!-- <link href="<?php echo base_url('assets/admin/jPlayer/skin/blue.monday/jplayer.blue.monday.css'); ?>" rel="stylesheet" type="text/css" /> -->
		<!--[if lt IE 8]><style>
	.img-container span, .img-container-mini span {
		...
		<script type="text/javascript">
			if (typeof jQuery === 'undefined') {
				document.write(unescape("%3Cscript src='../../assets/js/jquery.js' type='text/javascript'%3E%3C/script%3E"));
			}
		</script> -->
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/jquery.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/bootstrap.min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/bootstrap-lightbox.min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/jquery.touchSwipe.min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/modernizr.custom.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/bootbox.min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/bootstrap-modal.min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/bootstrap-modalmanager.min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/jquery.jplayer.min.js'); ?>"></script>
		<?php
		if ($aviary_active) {
	...
	<![endif]-->
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/jquery.ui.position.min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/jquery-ui-1.10.4.custom.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/jquery.ui.touch-punch.min.js'); ?>"></script>
		<script type="text/javascript" src="<?php echo base_url('/assets/admin/js/jquery.contextMenu.min.js'); ?>"></script>
		...
		<script type="text/javascript" src="<?php echo base_url('assets/admin/js/include.min.js');?>"></script>
	</head>
	...
	<body>
						...
						<ul class="grid cs-style-2 <?php echo "list-view" . $view; ?>" id="main-item-container">
							...
							?>
								<li data-name="<?php echo $file ?>" class="<?php if ($file == '..') echo 'back';
												else echo 'dir'; ?>" <?php if (($filter != '' && strpos($file, $filter) === false)) echo ' style="display:none;"'; ?>><?php
										...
										<?php } ?>
										<a class="folder-link" href="dialog?<?php echo $get_params . rawurlencode($src) . "&" . uniqid() ?>">
											<div class="img-precontainer">
												<div class="img-container directory"><span></span>
													<img class="directory-img" src="../../assets/admin/img/<?php echo $icon_theme; ?>/folder<?php if ($file == "..") {
																echo "_back";
															} ?>.png" />
												</div>
											</div>
							...
							foreach ($files as $nu => $file_array) {
								...
								if (in_array($extension_lower, $ext_img)) {
									...
									if (!file_exists($src_thumb)) {
										try {
											if (!create_img($file_path, $src_thumb, 348, 212)) {
												$src_thumb = $mini_src = "";
											} else {
									...
									if ($img_width < 348 && $img_height < 212) {
								...
								if ($src_thumb == "") {
									$no_thumb = true;
									if (file_exists(base_url('assets/img/' . $icon_theme . '/' . $extension_lower . '.jpg'))) {
										$src_thumb = base_url('assets/img/' . $icon_theme . '/' . $extension_lower . '.jpg');
									} else {
										$src_thumb = base_url('assets/img/' . $icon_theme . '/default.jpg');
									}
									$is_icon_thumb = true;
								}
								if ($mini_src == "") {
												...
												<form action="force_download.php" method="post" class="download-form" id="form<?php echo $nu; ?>">
													...
													<?php } elseif (($is_video || $is_audio) && in_array($extension_lower, $jplayer_ext)) { ?>
														<a class="tip-right modalAV <?php if ($is_audio) {
																									...
																									echo "video";
																								} ?>" title="<?php echo lang_Preview ?>" data-url="ajax_calls?action=media_preview&title=<?php echo $filename; ?>&file=<?php echo $current_path . $rfm_subfolder . $subdir . $file; ?>" href="javascript:void('');"><i class=" icon-eye-open"></i></a>
													<?php } elseif ($preview_text_files === TRUE && in_array($extension_lower, $previewable_text_file_exts)) { ?>
														<a class="tip-right file-preview-btn" title="<?php echo lang_Preview ?>" data-url="ajax_calls?action=get_file&sub_action=preview&title=<?php echo $filename; ?>&file=<?php echo $current_path . $rfm_subfolder . $subdir . $file; ?>" href="javascript:void('');"><i class=" icon-eye-open"></i></a>
													<?php } else { ?>
		...
		<div id="loading_container" style="display:none;">
			...
			<img id="loading_animation" src="<?php echo base_url('assets/admin/img/storing_animation.gif');?>" alt="loading" style="z-index:10001; margin-left:-32px; margin-top:-32px; position:fixed; left:50%; top:50%" />
		</div>
		<!-- loading div end -->
		...
		<?php if ($lazy_loading_enabled) { ?>
			<script src="<?php echo base_url('assets/admin/js/jquery.lazyload.min.js');?>" type="text/javascript"></script>
			<script src="<?php echo base_url('assets/admin/js/jquery.scrollstop.min.js');?>" type="text/javascript"></script>
