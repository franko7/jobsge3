...
$upload_dir = 'assets/uploads/banners/'; // path from base_url to base of upload folder (with start and final /)
$current_path = 'assets/uploads/banners/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = 'assets/uploads/banner-thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$access_keys = array("mKbq6ywj9YuJakAgzV2jc9JPJVnvY6PaFBqnYwwXkQh7ZuYbZB63BEuVrFffnF2E7gRGpYfzE9gfu63jyXXYugwJynALStfAkH7yxcHMbPTvxLrUAdvE6BYuNbQwuGVq");

//--------------------------------------------------------------------------------------------------------
// YOU CAN COPY AND CHANGE THESE VARIABLES INTO FOLDERS config.php FILES TO CUSTOMIZE EACH FOLDER OPTIONS
//--------------------------------------------------------------------------------------------------------

$MaxSizeUpload = 1024; //Mb
...
$ext_file 	= array('doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'csv','ppt','pptx','odt'); //Files
$ext_video 	= array('mov', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg','wma',"flv","webm"); //Video 
$ext_music 	= array('mp3', 'm4a', 'ac3'); //Audio
