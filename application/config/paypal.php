 ...
 * Client ID 
 */
$config['ClientID'] = 'AcY319h0dZyAPR6qcDnBtPkmiDdKrGlxzQ3imTgGOvHTZSA7SsJNl55Qr-9TsC14UPOe9L13-UwXi6ha';
 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'sb-bz8ed5755084_api1.business.example.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '9CHJLFNZJ52FS9WK' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'A0t7z4czL.7N9SgBNBXK1hMFdwcAAQUE3zcpv-JkTe7Jcq81H5Boa38X' : 'PRODUCTION_SIGNATURE_GOES_HERE';
